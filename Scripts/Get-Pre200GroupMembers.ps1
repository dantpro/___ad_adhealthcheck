...
Get-ADGroupMember -Identity 'Pre-Windows 2000 Compatible Access' |  Export-Csv -Path $OutputPath\Pre2000_group_members.csv -NoTypeInformation -Encoding UTF8 -Delimiter ";"
#endregion 
