...
$results  | export-csv -Path $OutputPath\Important_Accounts_Details.csv -NoTypeInformation -Encoding UTF8 -Delimiter ";"
...
$importantInfo | export-csv -Path $OutputPath\Important_Accounts_Details_sumamry.csv -NoTypeInformation -Encoding UTF8 -Delimiter ";"